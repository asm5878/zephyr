...
The Zephyr nucleo_wba65ri board configuration supports the following hardware features:
...
BLE support is enabled on nucleo_wba65ri. To build a zephyr sample using this board
